...
public class ParamAllele extends Allele {
    ...
    /**
     * Standard deviation of perturbations to values. This is generally set by
     * FloatValueMutationOperator according to the loaded properties file.
     */
    ...
    /**
     * Set value to random value from a Gaussian distribution determined by
     * {@link #RANDOM_STD_DEV}
     *
     * @param a_numberGenerator
     * @param onlyPerturbFromCurrentValue if true then the value is perturbed
