...
/**
 * A collection of {@link ParamGene}s or sub-ParamCollections. A ParamGene will
 * have an index within its ParamCollection, and if a ParamCollection has a
 * super-ParamCollection it will have in index within it. The main function of a
 * ParamCollection is to define common properties of ParamGenes or collections
 * thereof. Note that a ParamCollection does not maintain references to its
 * sub-collections or genes.
 */
public class ParamCollection {
    ...
    /**
     * Create a ParamCollection belonging to the specified super collection and
     * that defines a global min and max value.
     */
    ...
    /**
     * Create a ParamCollection belonging to the specified super collection and
     * that defines a min and max value for each gene.
     */
    ...
    /**
     * Get the minimum allowable value for a gene at the given index within its
     * collection (either this collection or a sub-collection of this
     * collection).
     *
    ...
    /**
     * Get the maximum allowable value for a gene at the given index within its
     * collection (either this collection or a sub-collection of this
     * collection).
     *
     * @param index The index of the param gene in its collection.
    ...
    /**
     * Get the minimum or maximum allowable value for a gene at the given index
     * within its collection (either this collection or a sub-collection of this
     * collection).
     *
     * @param minOrMax Whether to get the minimum or maximum allowable value,
     * specified by {@link #MIN_VALUE} and {@link #MAX_VALUE}.
