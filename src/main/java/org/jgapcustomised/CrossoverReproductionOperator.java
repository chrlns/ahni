...
public abstract class CrossoverReproductionOperator extends ReproductionOperator {
     ...
     *
     * @param config
     * @param parentChroms <code>List</code> contains <code>Chromosome</code>
     * objects
     * @param offspring <code>List</code> contains
     * <code>ChromosomeMaterial</code> objects, offspring of parents; total
     * number of chromosomes in parents and offspring should equal
